...
?>
                                ...
                                <div class="form-group row no-gutter">
                                    ...
                                    <div class="col-xs-4">
                                        <input class="qty-display form-control" type="text" readonly value='<?php echo $item["quantity"]; ?>' id="example-number-input">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info">
                                        <div class="price-container">
                                            <span class="price" data-price="<?php echo $product['price']; ?>">₹<?php echo $product['price']; ?></span>
                                        </div>
                                        <div class="action-wrap">
                                            <div class="qty-selector">
                                                <button type="button" class="qty-btn minus" onclick="var p=this.closest('.item-cart-info'); var qty=p.querySelector('.qty-display'); var pr=p.querySelector('.price'); var bp=parseFloat(pr.getAttribute('data-price')); if(parseInt(qty.value) > 1) { qty.value = parseInt(qty.value) - 1; pr.innerText='₹' + (bp * parseInt(qty.value)).toFixed(2); p.querySelector('.qty-input').value = qty.value; }">-</button>
                                                <input class="qty-display" type="text" value="1" readonly />
                                                <input type="hidden" name="quantity" class="qty-input" value="1" />
                                                <button type="button" class="qty-btn plus" onclick="var p=this.closest('.item-cart-info'); var qty=p.querySelector('.qty-display'); var pr=p.querySelector('.price'); var bp=parseFloat(pr.getAttribute('data-price')); qty.value = parseInt(qty.value) + 1; pr.innerText='₹' + (bp * parseInt(qty.value)).toFixed(2); p.querySelector('.qty-input').value = qty.value;">+</button>
                                            </div>
                                            <input type="submit" class="btn theme-btn add-to-cart" value="Add To Cart" />
                                        </div>
                                    </div>
                                    </form>
                                </div>
